...
public class TS0_FindBrokenLinks extends BaseClassHelper {
    ...
    public void verifyAllLinks(){
       ...
       test.info(MarkupHelper.createLabel("The current number of links found on OMCOZA is::"+allLinks.size(), ExtentColor.AMBER));
    ...
    public void sendMails() throws EmailException {
        this.sendEmails();
    }
}
