...
public class TS2_CheckTaxCalculator extends BaseClassHelper {
    ...
    public void checkTaxCalculators(ITestResult result,String intUserAge,String intMonthlySalary,String intOtherIncome,String intDeductionsOtherIncome,String intTaxable)
        ...
        //strGrossTaxIncome = calculators_Page.getGrossIncome();
        ...
        if (!strExpected.equals(strActual)){
            ...
            //test.info(MarkupHelper.createLabel("Assert Passed::Tax Calculator is functioning as expected",ExtentColor.BLUE));
