...
//        email.setAuthenticator(new DefaultAuthenticator("khuthelemanakaza@gmail.com", "aaaaaa"));
//        email.setSSLOnConnect(true);
//        email.setFrom("khuthelemanakaza@gmail.com");
//        email.setSubject("Digital Garage Test Execution Test Report");
//        email.setMsg("Good Day, \n\nThis is a test email generated by the Test Execution Report.\n\nPlease find attached report. \n\nRegards \nSQA Team");
//        email.addTo("khuthele.Manakaza@eoh.com");
//        email.send();
//    }
}
