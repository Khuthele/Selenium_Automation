...
public class TestReportEmailHelper extends BaseClassHelper
{
    ...
    static String fromEmail = getConfig().getFromEmail();
    static String toEmail = getConfig().getToEmail();
    static String passWord = "aaa";
...
//            }
            ...
            message.setSubject("Automation Test Execution Report_"  + strDate + " - On " + getConfig().getTestEnvironment()+ " Environment");

            //Create object to add email content
            //actual message body content
            BodyPart messageBodyAddEmailText = new MimeBodyPart();

            //Add report to email
            MimeBodyPart messageBodyAddHtmlReport = new MimeBodyPart();
            ...
            messageBodyAddHtmlReport.setFileName("Automation Test Execution Report _"+ strDate +".html");
